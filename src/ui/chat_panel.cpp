...
// Static member initialization
        ...
        ChatPanel::ChatPanel(HWND parentWindow, std::shared_ptr<utils::Config> config)
            ...
            logger.log(utils::LogLevel::INFO, "ChatPanel: Creating");
        }

        ChatPanel::~ChatPanel() {
            utils::Logger& logger = utils::Logger::getInstance();
            logger.log(utils::LogLevel::INFO, "ChatPanel: Destroying");
        ...
        bool ChatPanel::initialize() {
            ...
            if (!RegisterClassEx(&wcex)) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "ChatPanel: Failed to register panel class");
                return false;
            }
            ...
            if (!panelContainer_) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "ChatPanel: Failed to create panel container");
                return false;
            }
            ...
            utils::Logger& logger = utils::Logger::getInstance();
            logger.log(utils::LogLevel::INFO, "ChatPanel: Initialized");
            return true;
        }
