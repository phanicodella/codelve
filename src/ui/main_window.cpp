...
namespace codelve {
    namespace ui {
        ...
        MainWindow::MainWindow(std::shared_ptr<utils::Config> config, std::shared_ptr<core::Engine> engine)
            ...
            logger.log(utils::LogLevel::INFO, "MainWindow: Creating");
        }

        MainWindow::~MainWindow() {
            utils::Logger& logger = utils::Logger::getInstance();
            logger.log(utils::LogLevel::INFO, "MainWindow: Destroying");
        ...
        bool MainWindow::initialize() {
            ...
            if (!RegisterClassEx(&wcex)) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to register window class");
                return false;
            }
            ...
            if (!mainWindow_) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to create main window");
                return false;
            }
            ...
            utils::Logger& logger = utils::Logger::getInstance();
            logger.log(utils::LogLevel::INFO, "MainWindow: Initialized");
            return true;
        }
        ...
        void MainWindow::createMainWindow() {
            ...
            if (mainWindow_) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::INFO, "MainWindow: Created main window");
            }
            else {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to create main window");
        ...
        void MainWindow::createStatusBar() {
            ...
            if (statusBar_) {
                ...
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to create status bar");
            }
        }
        ...
        void MainWindow::createUIComponents() {
            ...
            if (fileBrowser_->initialize()) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::INFO, "MainWindow: Created file browser");
            }
            else {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to create file browser");
            }
            ...
            if (chatPanel_->initialize()) {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::INFO, "MainWindow: Created chat panel");
            }
            else {
                utils::Logger& logger = utils::Logger::getInstance();
                logger.log(utils::LogLevel::ERROR, "MainWindow: Failed to create chat panel");
            }
